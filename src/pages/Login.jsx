...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const { data, error: functionError } = await supabase.functions.invoke('verify-heartbeat-user', {
        body: { email: email }
      });
      ...
      if (!data.isMember) {
        setMessage("Access Denied: You must be a member of the WordBuddy community to log in.");
        setLoading(false);
